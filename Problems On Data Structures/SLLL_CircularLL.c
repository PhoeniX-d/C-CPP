...
int main()
{
    ...
    InsertLast(&Head, &Tail, 24);
    InsertLast(&Head, &Tail, 900);

    printf("Linked List:InsertLast\n");
    DisplayList(Head, Tail);

    InsertAtPos(&Head, &Tail, 233, 9);
    InsertAtPos(&Head, &Tail, 2235, 3);
...
//
////////////////////////////////////////////////////////////
void InsertLast(PPNODE First, PPNODE Last, int iNum)
{
    PNODE NewN = NULL;
    NewN = (PNODE)malloc(sizeof(NODE));
...
//
////////////////////////////////////////////////////////////
void InsertAtPos(PPNODE First, PPNODE Last, int iNum, int iPos)
{
