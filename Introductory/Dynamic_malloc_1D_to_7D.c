                    ...
                    )
{
    ...
    // allocation
    iArr = (int *)malloc(sizeof(int) * iFirst);
    if(NULL == iArr)
    {
                    ...
                    )
{
    ...
    for (i = 0; i < iFirst; i++)
    {
        if((iArr[i] = (int *)malloc(iSecond * sizeof(int))) == NULL)
        {
            printf("Memory Allocation Failed\n");
            return;
        }
                        ...
                        )
{
    ...
    // allocation
    iArr = (int ***)malloc(iFirst * sizeof(int **));
    for (i = 0; i < iFirst; i++)
    {
        iArr[i] = (int **)malloc(iSecond * sizeof(int *));
        for (j = 0; j < iSecond; j++)
        {
            iArr[i][j] = (int *)malloc(iThird * sizeof(int));
        }
    }
                        ...
                        )
{
    ...
    for (i = 0; i < iFirst; i++)
    {
        ...
        for (j = 0; j < iSecond; j++)
        {
            ...
            for(k = 0; k < iThird; k++)
            {
                iArr[i][j][k] = (int *)malloc(iFourth * sizeof(int));
            }
        }
    }
    ...
    for (i = 0; i < iFirst; i++)
    {
        ...
        for (j = 0; j < iSecond; j++)
        {
            ...
            for(k = 0; k < iThird; k++)
            {
                ...
                for (l = 0; l < iFourth; l++)
                {
                    iArr[i][j][k][l] = (int *)malloc(sizeof(int) * iFifth);
                }
            }
        }
    }
        ...
        for (j = 0; j < iSecond; j++)
        {
            ...
            for(k = 0; k < iThird; k++)
            {
                ...
                for (l = 0; l < iFourth; l++)
                {
                    ...
                    for (m = 0; m < iFifth; m++)
                    {
                        iArr[i][j][k][l][m] = (int *)malloc(iSixth * sizeof(int));
                    }
                }
            }
        }
            ...
            for(k = 0; k < iThird; k++)
            {
                ...
                for (l = 0; l < iFourth; l++)
                {
                    ...
                    for (m = 0; m < iFifth; m++)
                    {
                        ...
                        for (n = 0; n < iSixth; n++)
                        {
                            iArr[i][j][k][l][m][n] = (int *)malloc(iSeventh * sizeof(int));
                        }
                    }
                }
            }
