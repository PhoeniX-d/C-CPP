/*
*   Program to perform addition of the Matrix elements
*/
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    ...
    // Usage
    iRet = MatrixSum(iArr, iRow, iCol);
    printf("Summation of Matrix elements is\t:%d\n", iRet);
...
//  Input       :int[][], int, int
//  Returns     :int
//  Description :Returns summation of matrix elements
//  Author      :Pranav Choudhary
//  Date        :7 Oct 2020
//
/////////////////////////////////////////////////////////////
int MatrixSum(int *iArr[], int iRow, int iCol)
{
    if (iArr == NULL)
    {
