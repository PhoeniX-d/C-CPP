...
BOOL WriteInfo(char*, PSTUDENT, int);

int main()
{
    int iRecords = 0, i = 0;
    STUDENT student[MAXRECORD];
    char szFilename[MAXRECORD];
    ...
    scanf("%s" ,szFilename);
    WriteInfo(szFilename, student, iRecords);
    return 0;
}
...
//
///////////////////////////////////////////////////////////
BOOL WriteInfo(char *szFilename, PSTUDENT pstudent, int iSize)
{
