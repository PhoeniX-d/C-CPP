/* 
*   Program to read info of student whose legth of name is 6
*/
...
//  Input       :char[]
//  Returns     :BOOL
//  Description :Reads info of student whose legth of name is 6
...
BOOL ReadInfo(char* szFilename)
{
    ...
    if(flag == 1)
    {
        printf("Student with name length 6 not found!!\n");
    }
    close(fd);
    return TRUE;    
}
