/* 
*   Program to read info of student whose marks are even from a file
*/
...
//  Input       :char[]
//  Returns     :BOOL
//  Description :Reads info of student whose marks are even
...
BOOL ReadInfo(char* szFilename)
{
    ...
    if(flag == 1)
    {
        printf("Student with ecen marks not found!!\n");
    }
    close(fd);
    return TRUE;    
}
